...
@section('page-title', 'Incomes of ' . $category->name)
@section('content')
    <div class="row">
        <div class="col-lg-12">
            ...
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h4 class="card-title">
                        ...
                        <span class="text-muted font-size-12 mb-0"><i>{{ toCurrency($incomes->sum('amount'), true) }}</i></span>
                    </h4>

                    <div class="d-flex justify-content-between align-items-center">
                        <a href="{{ route('categories.incomes.create', [$category->id, 'route' => $route]) }} ">
                            <button type="button" class="btn btn-outline-primary btn-sm">{{ __('Add Income') }}</button>
                        </a>
                ...
                <div class="card-body">
                    <x-scheme
                        :data="$incomes"
                        :route="$route"
                        :viewRoute="'categories.incomes.show'"
