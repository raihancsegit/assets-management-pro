...
<form method="GET" action="{{ route('milkProductionReport') }}">
    <input type="hidden" name="custom_action" value="milkProductionReport">
    <div id="milkProductionReport" class="modal fade" tabindex="-1" aria-labelledby="exampleModalFullscreenLabel" aria-hidden="true">
        <div class="modal-dialog modal-fullscreen">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalFullscreenLabel">{{ __('Milk Production Report')}}</h5>
