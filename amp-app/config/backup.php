...
return [
    ...
    'notifications' => [
        ...
        'mail' => [
            'to' => 'sagor.touch@gmail.com',

            'from' => [
                'address' => env('MAIL_FROM_ADDRESS', 'no-reply@amp.com'),
                'name' => env('MAIL_FROM_NAME', 'Backup'),
            ],
        ],

        'slack' => [
            'webhook_url' => 'https://hooks.slack.com/services/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',
